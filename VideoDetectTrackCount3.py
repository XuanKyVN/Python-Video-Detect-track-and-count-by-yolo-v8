...
from videotrackcountscreen3 import Ui_MainWindow
import imutils
# -----------------Counting Thread-----------------
...
class VideoThread(QThread):
    ...
    def run(self):
        ...
        if yolo_path != "" and video_path != "" and not self.CountMode:
        ...
        elif yolo_path != "" and video_path != "" and self.CountMode and (self.PolygonPoint or self.LinePoint):
            model = YOLO(yolo_path)
            cap = cv2.VideoCapture(video_path)
            ...
            while cap.isOpened():
                ...
                if success:
                    ...
                    frame = imutils.resize(frame,width=1540)
                    ...
                    if results[0].boxes.id != None:
                        ...
                        cv2.putText(annotated_frame, "Xuan Ky Automation", (550, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.8,
                                    (235, 255, 0), 2)
                        self.change_pixmap_signal.emit(annotated_frame)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        # ------------------------------------------------------
        self.disply_width = 1540
        self.display_height = 940
