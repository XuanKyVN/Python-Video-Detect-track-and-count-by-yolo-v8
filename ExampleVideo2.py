...
from PyQt5.QtWidgets import QWidget, QApplication, QLabel, QVBoxLayout,QMenu, QAction,QPushButton
...
class App(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.button1 =QPushButton('Senddata')
    ...
    def send(self):
        self.videopath.emit("C:/Users/Admin/PythonLession/pic/carplate6.mp4")
