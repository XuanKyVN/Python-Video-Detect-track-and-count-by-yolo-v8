...
#----------------------------------------------
    ...
    def update_image(self, cv_img):
        ...
        if len(self.RecPoint)>0:
            #print(self.RecPoint)
            cv_img = cv2.rectangle(cv_img,(self.RecPoint[0][0],self.RecPoint[0][1]),(self.RecPoint[0][2],self.RecPoint[0][3]),(255,0,0),3)
            cv2.circle(cv_img,(self.RecPoint[0][0],self.RecPoint[0][1]),10,(255,0,0),3)
            cv2.circle(cv_img,(self.RecPoint[0][2],self.RecPoint[0][3]),10,(255,0,0),3)
...
#----------------------------------------------DRAWN------------------
    ...
    def set_region(self):
        if self.PolygonPoint and self.uic.ComboBox.currentIndex()==2:
            print(self.PolygonPoint)
            self.PolygonPoint.pop(len(self.PolygonPoint)-1)
            #del self.PolygonPoint[len(self.PolygonPoint)-1]
            self.PolygonPoint.append(self.PolygonPoint[0])
            print(self.PolygonPoint)
        elif self.RecPoint and self.uic.ComboBox.currentIndex()==1:
            x1=self.RecPoint[0][0]
            y1=self.RecPoint[0][1]
            x2=self.RecPoint[0][2]
            y2=self.RecPoint[0][3]
            point=[]
